...
const subjects = [
  {
    ...
    description:
      "Learn at your own pace with our flexible curriculum. Access comprehensive courses designed to fit your schedule and learning style.",
    features: [
      "24/7 course access",
      "Interactive lessons",
      "Progress tracking",
  ...
  },
  {
    ...
    description:
      "Master essential skills for today's job market. From technical to soft skills, our courses help you stay competitive.",
    features: [
  ...
  },
  {
    ...
    description:
      "Earn recognized certifications that boost your career. Our programs are designed in collaboration with industry experts.",
    features: [
...
const testimonials = [
  {
    ...
    content:
      "This platform helped me transition into tech. The structured learning path and career guidance were invaluable!",
  ...
  },
  {
    ...
    content:
      "The perfect complement to my university studies. The practical projects helped me understand concepts better.",
  ...
  },
  {
    ...
    role: "Professional",
    content:
      "The flexibility to learn while working full-time was crucial. I could upgrade my skills without compromising my job.",
...
const faqs = [
  {
    ...
    answer:
      "Our platform offers flexible, self-paced learning with interactive courses, practical assignments, and real-time progress tracking. You can learn anytime, anywhere.",
  },
  {
    question: "Are the certificates recognized?",
    answer:
      "Yes, our certificates are industry-recognized and accredited. They're designed in partnership with leading companies and educational institutions.",
  },
  {
    question: "How long do I have access to courses?",
    answer:
      "Once enrolled, you have lifetime access to the course materials. Learn at your own pace and revisit content whenever needed.",
  },
  {
    question: "Is there support available?",
    answer:
      "Yes, we offer comprehensive support including mentor guidance, community forums, and technical assistance throughout your learning journey.",
  },
];
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-600 dark:text-gray-300 mb-8">
            Access world-class education at your fingertips. Learn, grow, and
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-600 dark:text-gray-300 mb-16 max-w-3xl mx-auto">
            Discover how our learning platform adapts to your needs and helps
